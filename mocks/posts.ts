...
export const posts: Post[] = [
  {
    ...
    user: {
      id: "user1",
      username: "Krhisha Marie O. Cavan",
    ...
    caption: "Enjoying the sunset at the beach 🌅 #sunset #beach #vacation #summer",
    likes: 243,
    liked: false,
    comments: [
      {
  ...
  },
  {
    ...
    caption: "City lights and urban nights 🌃 #cityscape #nightphotography #urban #lights",
    likes: 512,
    liked: true,
    comments: [
      {
  ...
  },
  {
    ...
    caption: "Homemade pasta with fresh ingredients from the farmers market 🍝 #foodcorn #homemade #pasta #cooking #foodie",
    likes: 876,
    liked: false,
    comments: [
      {
  ...
  },
  {
    ...
    caption: "My urban jungle is growing! 🌿 New additions to the plant family #plants #urbanjungle #houseplants #plantaddict",
    likes: 621,
    liked: true,
    comments: [],
    commentCount: 93,
